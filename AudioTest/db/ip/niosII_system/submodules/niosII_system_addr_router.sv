...
(
    ...
    localparam PAD10 = log2ceil(64'h1109078 - 64'h1109070);
    localparam PAD11 = log2ceil(64'h1109080 - 64'h1109078);
    localparam PAD12 = log2ceil(64'h1109082 - 64'h1109080);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1109082;
    ...
    always @* begin
        ...
        // ( 0x1109078 .. 0x1109080 )
        if ( {address[RG:PAD11],{PAD11{1'b0}}} == 25'h1109078 ) begin
            src_channel = 13'b0000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
        end

        // ( 0x1109080 .. 0x1109082 )
        if ( {address[RG:PAD12],{PAD12{1'b0}}} == 25'h1109080 ) begin
